...
- Explore [collections](/concepts/composition) for composing many features
- Learn about [tree-based navigation](/guides/navigation) for complex hierarchies
- See [shared state](/guides/sharing-state) for sharing data across features