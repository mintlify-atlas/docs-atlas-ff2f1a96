...
<CardGroup cols={2}>
  <Card title="Tree-based" icon="sitemap" href="/navigation/tree-based">
    Use optionals and enums to model navigation in a tree-like structure
  </Card>
  <Card title="Stack-based" icon="layer-group" href="/navigation/stack-based">
...
<CardGroup cols={2}>
  ...
  <Card title="Stack-based Navigation" icon="bars-staggered" href="/navigation/stack-based">
